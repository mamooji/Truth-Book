  ...
  return (
    <Layout>
      ...
      >
        ...
        based on this goal. For example, if someone who is an avid smoker wants
        to try quitting but hasn't been able to, this app gives them the
        ...
        users to have multiple goals set, and shows a calender history of all of
        the times their goal has been achieved, or failed. This can be used for
        something as simple as a reminder to take out the garbage on Sunday
        night, to overcoming habits or challenging circumstances.
      </p>
    </Layout>
  );
}
